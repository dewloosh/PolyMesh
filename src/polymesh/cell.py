...
from .utils.utils import (jacobian_matrix_bulk, points_of_cells,
...
class PolyCell1d(PolyCell):
    ...
    def points_of_cells(self, *, points:Union[float, Iterable]=None, 
                        cells:Union[int, Iterable]=None, flatten:bool=False,
                        target:Union[str, CartesianFrame]='global', 
                        rng:Iterable=None, **kwargs) -> Union[dict, ndarray]:
