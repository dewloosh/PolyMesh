...
def generate_notebook_gallery_rst(title:str = "Gallery", reversed:bool=False):
    
    file_path = os.path.abspath(__file__)
    folder_path = os.path.dirname(file_path)
    gallery_rst_path = os.path.join(folder_path, 'notebook_gallery.rst')
    gallery_folder_path = os.path.join(folder_path, 'gallery')
