...
release = polymesh.__version__ + '-git'
...
latex_documents = [
    ('index', 'polymesh.tex', u'polymesh Documentation',
...
man_pages = [
    ('index', 'polymesh', u'polymesh Documentation',
     [u'Bence Balogh'], 1)
]
...
texinfo_documents = [
    ('index', 'polymesh', u'polymesh Documentation',
     u'Bence Balogh', 'polymesh', 'One line description of project.',
     'Miscellaneous'),
]
...
sphinx_gallery_conf = {
    ...
    #'junit': os.path.join('polymesh', 'junit-results.xml'),
...
"""html_context = {
    ...
    'versions': (
        ('dev', 'https://github.com/dewloosh/polymesh/tree/main'),
        ('stable', 'https://github.com/dewloosh/polymesh/tree/main'),
    )
}"""